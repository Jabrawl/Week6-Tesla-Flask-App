...
class Car(db.Model):
    ...
    def __init__(self, name, description, price, color, model, year, mileage, cost_of_production, user_token, id = ''):
        self.id = self.set_id()
        self.name = name
    ...
    def __repr__(self):
        return f"The following Tesla has been added: {self.name}"
    

class CarSchema(ma.Schema):
    class Meta:
        fields = ['id', 'name', 'description', 'price', 'color', 'model', 'year', 'mileage', 'cost_of_production']
